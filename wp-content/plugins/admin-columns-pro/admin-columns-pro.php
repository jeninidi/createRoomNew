...
add_action( 'after_setup_theme', function () {
	...
	require_once __DIR__ . '/classes/Editing/load.php';
	require_once __DIR__ . '/classes/Export/load.php';
	require_once __DIR__ . '/classes/Filtering/load.php';
	require_once __DIR__ . '/classes/Search/load.php';
	require_once __DIR__ . '/classes/Sorting/load.php';
