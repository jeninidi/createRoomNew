...
$form->add_element( 'select', 'map_all_control[locateme_control_position]', array(
	'label' => __( 'Locate Me Control', WPGMP_TEXT_DOMAIN ),
	'current' => $data['map_all_control']['locateme_control_position'],
	'desc' => __( 'Please select position of locate me control.', WPGMP_TEXT_DOMAIN ),
	'options' => $positions,
));